            ...
            <div className='box-faculty'>
                <div>
                    ...
                    <div className='description-faculty'>
                        Кафедра математического обеспечения и применения ЭВМ была организована в 1973 году по инициативе
                        д.т.н. профессора А.Н. Мелихова для подготовки специалистов в области разработки программного
                        обеспечения для электронно-вычислительных машин. Lorem ipsum dolor sit amet, consectetur
                        adipisicing elit. Aliquid animi culpa doloremque doloribus? Accusantium ad alias amet aperiam
